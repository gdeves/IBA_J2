...
public class ADC{
    ...
    /**
     * 
     * @param position, position of event in eventlist
     * @param x , x value to add
     */
    public void setX(int position,int x){
        int[] event=eventList.get(position);
        event[0]=x;
     ...
     * 
     * @param position, position of event in eventlist
     * @param e , Energy value to add
     */
    public void setE(int position,int e){
        int[] event=this.eventList.get(position);
        event[2]=e;
        this.eventList.remove(position);
        this.eventList.add(position,event);
    }
    /**
